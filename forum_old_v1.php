    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">News feed</h3>
            ...
            <div class="row  align-items-center justify-content-center text-center h-100">
                <div class="">
                    ...
                    <span class="badge badge-info float-left px-3 pt-1 pb-1">
                     ...
                     <span>
                        <button class="btn btn-primary float-right view_topic" data-id="<?php echo $row['id'] ?>"><i class="fa fa-comments" style="color:grey"></i><?php echo $count_comments ?></button>
                    </span>

                    <span >
                        <button class="btn btn-primary float-right view_topic" data-id="<?php echo $row['id'] ?>"><i class="fa fa-thumbs-up" style="color:grey"></i> <i><?php echo $count_comments ?></i></button>
                    </span>

		...
		<div class="card">
			<div class="card-body">
				<form action="" id="manage-event">
					...
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Meeting Link</label>
							<input type="text" class="form-control" name="meetinglink"  value="<?php echo isset($meetinglink) ? $meetinglink :'' ?>" required >
						</div>
					</div>

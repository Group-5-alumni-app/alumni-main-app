...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=courses" class="nav-item nav-courses"><span class='icon-field'><i class="fas fa-book-reader"></i></span> Course List</a>
				<!-- <a href="index.php?page=webinar" class="nav-item nav-courses"><span class='icon-field'><i class="fas fa-podcast"></i></span> Webinars</a> -->
				...
				<a href="index.php?page=events" class="nav-item nav-events"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> Webinars</a>

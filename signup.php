                                    ...
                                    <form action="" id="create_account">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="custom-select select2" name="course_id" id="courseselect" required>
                                                ...
                                                <input type="input" class="form-control otherC" name="otherC" id="otherr" required placeholder='Enter Other Course'>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-5">
                                                <label for="" class="control-label">Current employer </label>
    ...
    $.ajax({
        ...
        success:function(resp){
            if(resp == 1){
                ...
                $('#msg').html('<div class="alert alert-success">makes it to line 150</div>')
                end_load()
            }
            else if(resp == 2){

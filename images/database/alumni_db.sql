...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2021 at 10:16 PM
...
CREATE TABLE `alumnus_bio` (
  ...
  `current__employer` text NOT NULL,
...
INSERT INTO `alumnus_bio` (`id`, `firstname`, `middlename`, `lastname`, `gender`, `batch`, `course_id`, `email`, `current__employer`, `avatar`,`CV` ,`status`, `date_created`, `CV`) VALUES
...
INSERT INTO `NewsFeed_comments` (`id`, `topic_id`, `comment`, `user_id`, `date_created`) VALUES
...
--
-- Table structure for table `NewsFeed_topics`
--

CREATE TABLE `NewsFeed_topics` (
  `id` int(30) NOT NULL,
  `title` varchar(250) NOT NULL,
  `description` text NOT NULL,
  `user_id` int(30) NOT NULL,
...
--
-- Dumping data for table `NewsFeed_topics`
--

INSERT INTO `NewsFeed_topics` (`id`, `title`, `description`, `user_id`, `date_created`) VALUES
...
--
--Table structure for forgot password 'users1`
--
CREATE TABLE `users1` (
  `id` int(30) NOT NULL,
  `name` text NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `lastname`,`email`, `password`, `Token`, `TokenExpire`) VALUES
(1, 'Ofentse',`Kekana`,`Kekana@gmail.com`,1234,'','')
